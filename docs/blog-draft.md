...
> 实际时间需要根据开发记录补齐。最终发布前应确保总时间与各阶段时间一致。

| PSP2.1 阶段 | 预估耗时（分钟） | 实际耗时（分钟） | 偏差原因 |
| --- | ---: | ---: | --- |
| Planning：明确作业要求与开发计划 | 【待补充】 | 【待补充】 | 需要同时考虑功能、原型、博客和工程规范 |
| Estimate：任务拆分与工作量估算 | 【待补充】 | 【待补充】 | 前期低估了页面细节和数据适配工作量 |
| Analysis：需求分析与 NABCD | 【待补充】 | 【待补充】 | 【待补充】 |
| Design Spec：系统与接口设计 | 【待补充】 | 【待补充】 | 【待补充】 |
| Design Review：设计复核 | 【待补充】 | 【待补充】 | 多次对照 Figma 调整视觉比例 |
| Coding Standard：制定代码规范 | 【待补充】 | 【待补充】 | 【待补充】 |
| Design：Figma 页面和交互原型 | 【待补充】 | 【待补充】 | 页面较多，组件状态需要逐一补充 |
| Coding：前后端功能实现 | 【待补充】 | 【待补充】 | 外部 API、CSV 校验和响应式布局增加工作量 |
| Code Review：代码检查与重构 | 【待补充】 | 【待补充】 | 【待补充】 |
| Test：单元测试与接口测试 | 【待补充】 | 【待补充】 | 需要覆盖外部服务异常分支 |
| Reporting：博客与文档整理 | 【待补充】 | 【待补充】 | 截图、AI 协作记录和代码说明内容较多 |
| 合计 | 【待补充】 | 【待补充】 | 【待补充】 |
